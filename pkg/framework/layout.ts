...
import {VFactory} from "./factory";
import {ViewOptions, LayoutItem, IViewContainer, } from "./types"
import {VContainerStandard} from "%/framework/vContainer";
...
export async function initBrowserViews(win: BrowserWindow, opts: ( LayoutItem | ViewOptions )[]): Promise<IViewContainer[]> {
    const views: IViewContainer[] = [];
